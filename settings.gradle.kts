...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            version("adventure-text-feature-pagination", "-SNAPSHOT")
            ...
            library("adventure.text.feature.pagination", "com.github.KyoriPowered", "adventure-text-feature-pagination").versionRef("adventure-text-feature-pagination")
